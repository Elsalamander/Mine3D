package it.elsalamander.mine3d.Game.Settings.ControlSettings.Sensivity

import android.app.Activity
import android.widget.SeekBar
import it.elsalamander.mine3d.Game.Settings.Setting

class Sensivity(context : Activity) :  Setting<Double>(0.5, context), SeekBar.OnSeekBarChangeListener{
