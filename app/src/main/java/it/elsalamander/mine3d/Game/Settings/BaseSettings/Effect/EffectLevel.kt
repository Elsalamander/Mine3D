package it.elsalamander.mine3d.Game.Settings.BaseSettings.Effect
 ...
 * @version: v1.0
 ****************************************************************/
class EffectLevel(context : Activity) : Setting<Int>(25, context), SeekBar.OnSeekBarChangeListener{
    /**
    ...
    override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
        ...
        val cent = this.context.findViewById<TextView>(R.id.settings_Effect_cent)
